...
<img src="/images/user-guide/basic-features/views/views-kanban-view.png" alt="Kanban view interface" style="max-width: 100%; border: 1px solid #e0e0e0; border-radius: 4px;">
