...
<img src="/images/user-guide/basic-features/self-sript.jpeg" alt="自定义脚本节点配置面板" style="max-width: 100%; border: 1px solid #e0e0e0; border-radius: 4px;">
...
| 版本 | 日期 | 变更说明 |
|------|------|---------|
| 1.1 | 2026-08-12 | 同步更新脚本节点完整文档：补充配置面板详解（4.2）、错误处理与重试策略（4.4）、循环体内案例（5.3）、附录 API/错误码/工具链/迁移/测试套件（第 7 章），并在「添加脚本节点」处补充配置面板示意图 |
