...
文档权限与所属 Base 的权限体系一致。各角色对文档及其版本的操作权限如下：

| 角色 | 创建文档 | 编辑 / 保存文档 | 删除文档 | 手动创建版本 | 恢复版本 | 删除版本 | 查看 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 所有者 / 管理员 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅（全部文档） |
| 编辑者 | ❌ | ✅ | ❌ | ❌ | ✅ | ❌ | ✅（有权限的文档） |
| 评论者 / 查看者 | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅（仅查看） |
...
::: tip 说明
- **编辑者**仅能编辑并保存文档内容、恢复历史版本（回滚文档内容），但**不能创建或删除文档**，也**不能手动创建或删除版本**。
- 文档的创建与删除、版本的创建与删除均属于管理操作，需要**管理员（Admin）及以上**权限。
:::
